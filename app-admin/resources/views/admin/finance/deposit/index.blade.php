...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">财务管理 - 缴纳保证金列表</li>
    </ol>
@stop
            ...
            <div class="row">
                <form class="">
                    ...
                    <div class="search_but">
                        ...
                        <a type="reset" href="{{route('admin.order.deposit.index')}}"
                ...
                @foreach(($items ?? []) as $item)
                    <tr>
                        <td>
                            ...
                            <a style="font-size: 16px" href="{{route('admin.order.deposit.delete', ['id' => $item->id])}}"><i class="fa fa-fw fa-trash-o" title="删除"></i></a>
                        </td>
                        <td class="text-muted">{{$item->carriersUser->company_name or ''}}</td>
                        <td class="text-muted">{{$item->money}}</td>
