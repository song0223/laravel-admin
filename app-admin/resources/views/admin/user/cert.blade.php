...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">货主管理 - 资质审核</li>
    </ol>
@stop

@section('content')
    <span><a type="reset" href="{{route('admin.user.index')}}" class="btn btn-primary">返回</a></span>
    <form method="POST" action="#" accept-charset="utf-8">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <a href="{{route('admin.user.change-audit', ['id' => $cert_info->id, 'audit' => $cert_info::CHECK_YES])}}" class="btn btn-primary">审核通过</a>
    ...
    <script>
        $('#through').click(function () {
            if ($('#not_through').css('display') == 'block') {
                ...
                window.location.href='{{route('admin.user.change-audit', ['id' => $cert_info->id, 'audit' => $cert_info::CHECK_NO])}}' + '?not_through=' +content;
            }
