...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{route('admin.user.index')}}">货主管理</a> - 货主地址</li>
    </ol>
@stop
            ...
            <div class="row">
                <form class="">
                    ...
                    <div class="search_but">
                        ...
                        <a type="reset" href="{{route('admin.user.address', ['id' => $id ?? 0])}}" class="cz-btn btn-danger">重置</a>
                    </div>
                </form>
            </div>
        </div>
